...
@section('title', "Edit RecruitingPhase # $recruitingphase->name ")
...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit RecruitingPhase #{{ $recruitingphase->name }}</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Edit RecruitingPhase #{{ $recruitingphase->name }}</div>
            <div class="card-body">
                ...
                {!! Form::model($recruitingphase, [
                    'method' => 'PATCH',
                    'url' => ['/recruiting-phases', $recruitingphase->id],
                    'class' => 'form-horizontal',
                    'files' => true
                ]) !!}

                @include ('recruiting-phases.form', ['formMode' => 'edit'])
