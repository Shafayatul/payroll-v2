...
@section('title', "Edit CostCenter # $costcenter->name ")
...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit CostCenter #{{ $costcenter->name }}</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Edit CostCenter #{{ $costcenter->name }}</div>
            <div class="card-body">
                ...
                @include ('cost-centers.form', ['formMode' => 'edit'])
