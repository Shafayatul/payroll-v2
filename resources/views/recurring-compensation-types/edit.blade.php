...
@section('title', "Edit RecurringCompensationType # $recurringcompensationtype->name ")
...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit RecurringCompensationType #{{ $recurringcompensationtype->name }}</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Edit RecurringCompensationType #{{ $recurringcompensationtype->name }}</div>
            <div class="card-body">
                ...
                @include ('recurring-compensation-types.form', ['formMode' => 'edit'])
