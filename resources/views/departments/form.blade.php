...
<div class="form-group {{ $errors->has('working_hour') ? 'has-error' : ''}}">
    {!! Form::label('working_hour', 'Working Hour', ['class' => 'control-label']) !!}
    {!! Form::number('working_hour', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
