...
@section('title', 'Edit Industry #{{ $industry->id }}')
...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Industry #{{ $industry->id }}</li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Edit Industry #{{ $industry->id }}</div>
            <div class="card-body">
                ...
                @include ('industries.form', ['formMode' => 'edit'])
